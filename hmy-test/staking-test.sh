...
test_HMY_Validator_Creation_Non_Present_signer_address() {
    test_cmd="echo ${BLS_PASSPHRASE} | ${HMYCLIBIN} --node=http://${apiendpoint} staking create-validator --validator-addr ${NOT_PRESENT_VALIDATOR_ADDR} --name John --identity john --website john@harmony.one --security-contact Alex --details 'John the validator' --rate 0.1 --max-rate 0.9 --max-change-rate 0.05 --min-self-delegation 2 --max-total-delegation 30 --bls-pubkeys ${BLS_PUBKEY} --amount 3 --chain-id ${chainid}"
    echo "command executed : ${test_cmd}"
    output=$((eval "${test_cmd}") 2>&1)
    returncode=$?
    echo "command output : ${output}"
...
test_HMY_Validator_Creation_Name_lenght() {
    test_cmd="echo ${BLS_PASSPHRASE} | ${HMYCLIBIN} --node=http://${apiendpoint} staking create-validator --validator-addr ${VALIDATOR_ADDR} --name JohnsJohnsJohnsJohnsJohnsJohnsJohnsJohnsJohnsJohnsJohnsJohnsJohnsJohnsJohnsJohns --identity john --website john@harmony.one --security-contact Alex --details 'John the validator' --rate 0.1 --max-rate 0.9 --max-change-rate 0.05 --min-self-delegation 2 --max-total-delegation 30 --bls-pubkeys ${BLS_PUBKEY} --amount 3 --chain-id ${chainid}"
    echo "command executed : ${test_cmd}"
    output=$((eval "${test_cmd}") 2>&1)
    returncode=$?
    echo "command output : ${output}"
...
test_HMY_Validator_Edit_Name_lenght() {
    test_cmd="echo ${BLS_PASSPHRASE} | ${HMYCLIBIN} --node=http://${apiendpoint} staking edit-validator --validator-addr ${VALIDATOR_ADDR} --name JohnsJohnsJohnsJohnsJohnsJohnsJohnsJohnsJohnsJohnsJohnsJohnsJohnsJohnsJohnsJohns --identity john --website john@harmony.one --security-contact Alex --details 'John the validator' --rate 0.1 --min-self-delegation 2 --max-total-delegation 30 --remove-bls-key ${BLS_PUBKEY} --add-bls-key ${BLS_PUBKEY} --chain-id ${chainid}"
    echo "command executed : ${test_cmd}"
    output=$((eval "${test_cmd}") 2>&1)
    returncode=$?
    echo "command output : ${output}"
...
test_HMY_Validator_Creation_Identity_lenght() {
    test_cmd="echo ${BLS_PASSPHRASE} | ${HMYCLIBIN} --node=http://${apiendpoint} staking create-validator --validator-addr ${VALIDATOR_ADDR} --name John --identity John_ --website john@harmony.one --security-contact Alex --details 'John the validator' --rate 0.1 --max-rate 0.9 --max-change-rate 0.05 --min-self-delegation 2 --max-total-delegation 30 --bls-pubkeys ${BLS_PUBKEY} --amount 3 --chain-id ${chainid}"
    echo "command executed : ${test_cmd}"
    output=$((eval "${test_cmd}") 2>&1)
    returncode=$?
    echo "command output : ${output}"
...
#     test_cmd="echo ${BLS_PASSPHRASE} | ${HMYCLIBIN} --node=http://${apiendpoint} staking edit-validator --validator-addr ${VALIDATOR_ADDR} --name John --identity John_ --website john@harmony.one --security-contact Alex --details 'John the validator' --rate 0.1 --min-self-delegation 2 --max-total-delegation 30 --remove-bls-key ${BLS_PUBKEY} --add-bls-key ${BLS_PUBKEY} --chain-id ${chainid}"
#     echo "command executed : ${test_cmd}"
#     output=$((eval "${test_cmd}") 2>&1)
#     returncode=$?
#     echo "command output : ${output}"
...
#     test_cmd="echo ${BLS_PASSPHRASE} | ${HMYCLIBIN} --node=http://${apiendpoint} staking edit-validator --validator-addr ${VALIDATOR_ADDR} --name John --identity John --website john@harmony.one_gjuDthEfXKsguvVih7WEFGgQRbolcgAeg40lO6zz0pHsfbh2sdMarB9mmopL6WdQlCJ3CJmp2437Qw4Hcyp47L2gBhNTZ8D6DjQ0UkK42Q5JkB3GuDUiyMNtMEVNXiN5ddTWQtcfuJ5P --security-contact Alex --details 'John the validator' --rate 0.1 --min-self-delegation 2 --max-total-delegation 30 --remove-bls-key ${BLS_PUBKEY} --add-bls-key ${BLS_PUBKEY} --chain-id ${chainid}"
#     echo "command executed : ${test_cmd}"
#     output=$((eval "${test_cmd}") 2>&1)
#     returncode=$?
#     echo "command output : ${output}"
...
#     test_cmd="echo ${BLS_PASSPHRASE} | ${HMYCLIBIN} --node=http://${apiendpoint} staking edit-validator --validator-addr ${VALIDATOR_ADDR} --name John --identity John --website john@harmony.one --security-contact Alex_gjuDthEfXKsguvVih7WEFGgQRbolcgAeg40lO6zz0pHsfbh2sdMarB9mmopL6WdQlCJ3CJmp2437Qw4Hcyp47L2gBhNTZ8D6DjQ0UkK42Q5JkB3GuDUiyMNtMEVNXiN5ddTWQtcfuJ5P --details 'John the validator' --rate 0.1 --min-self-delegation 2 --max-total-delegation 30 --remove-bls-key ${BLS_PUBKEY} --add-bls-key ${BLS_PUBKEY} --chain-id ${chainid}"
...
#     test_cmd="echo ${BLS_PASSPHRASE} | ${HMYCLIBIN} --node=http://${apiendpoint} staking edit-validator --validator-addr ${VALIDATOR_ADDR} --name John --identity John --website john@harmony.one --security-contact Alex --details 'John the validator ' --rate 0.1  --min-self-delegation 2 --max-total-delegation 30 --remove-bls-key ${BLS_PUBKEY} --add-bls-key ${BLS_PUBKEY} --chain-id ${chainid}"
#     echo "command executed : ${test_cmd}"
#     output=$((eval "${test_cmd}") 2>&1)
#     returncode=$?
#     echo "command output : ${output}"
