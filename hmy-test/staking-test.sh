...
#this address need to be imported to the keystore with the validator account
...
test_HMY_Validator_Creation_Non_Present_signer_address() {
    output=$((${HMYCLIPATH} --node=http://${apiendpoint} staking create-validator --validator-addr ${NOT_PRESENT_VALIDATOR_ADDR} --name John --identity john --website john@harmony.one --security-contact Alex --details "John the validator" --rate 0.1 --max-rate 0.9 --max-change-rate 0.05 --min-self-delegation 2 --max-total-delegation 30 --bls-pubkeys 0xb9486167ab9087ab818dc4ce026edb5bf216863364c32e42df2af03c5ced1ad181e7d12f0e6dd5307a73b62247608611 --amount 3 --chain-id ${chainid}) 2>&1)
    returncode=$?
...
test_HMY_Validator_Creation_Name_lenght() {
    output=$((${HMYCLIPATH} --node=http://${apiendpoint} staking create-validator --validator-addr ${VALIDATOR_ADDR} --name JohnsJohnsJohnsJohnsJohnsJohnsJohnsJohnsJohnsJohnsJohnsJohnsJohnsJohnsJohnsJohns --identity john --website john@harmony.one --security-contact Alex --details "John the validator" --rate 0.1 --max-rate 0.9 --max-change-rate 0.05 --min-self-delegation 2 --max-total-delegation 30 --bls-pubkeys 0xb9486167ab9087ab818dc4ce026edb5bf216863364c32e42df2af03c5ced1ad181e7d12f0e6dd5307a73b62247608611 --amount 3 --chain-id ${chainid}) 2>&1)
    returncode=$?
...
test_HMY_Validator_Edit_Name_lenght() {
    output=$((${HMYCLIPATH} --node=http://${apiendpoint} staking edit-validator --validator-addr ${VALIDATOR_ADDR} --name JohnsJohnsJohnsJohnsJohnsJohnsJohnsJohnsJohnsJohnsJohnsJohnsJohnsJohnsJohnsJohns --identity john --website john@harmony.one --security-contact Alex --details "John the validator" --rate 0.1 --min-self-delegation 2 --max-total-delegation 30 --remove-bls-key 0xb9486167ab9087ab818dc4ce026edb5bf216863364c32e42df2af03c5ced1ad181e7d12f0e6dd5307a73b62247608611 --add-bls-key 0xb9486167ab9087ab818dc4ce026edb5bf216863364c32e42df2af03c5ced1ad181e7d12f0e6dd5307a73b62247608611 --chain-id ${chainid}) 2>&1)
    returncode=$?
...
test_HMY_Validator_Creation_Identity_lenght() {
    output=$((${HMYCLIPATH} --node=http://${apiendpoint} staking create-validator --validator-addr ${VALIDATOR_ADDR} --name John --identity John_ --website john@harmony.one --security-contact Alex --details "John the validator" --rate 0.1 --max-rate 0.9 --max-change-rate 0.05 --min-self-delegation 2 --max-total-delegation 30 --bls-pubkeys 0xb9486167ab9087ab818dc4ce026edb5bf216863364c32e42df2af03c5ced1ad181e7d12f0e6dd5307a73b62247608611 --amount 3 --chain-id ${chainid}) 2>&1)
    returncode=$?
...
test_HMY_Validator_Edit_Identity_lenght() {
    output=$((${HMYCLIPATH} --node=http://${apiendpoint} staking edit-validator --validator-addr ${VALIDATOR_ADDR} --name John --identity John_ --website john@harmony.one --security-contact Alex --details "John the validator" --rate 0.1 --min-self-delegation 2 --max-total-delegation 30 --remove-bls-key 0xb9486167ab9087ab818dc4ce026edb5bf216863364c32e42df2af03c5ced1ad181e7d12f0e6dd5307a73b62247608611 --add-bls-key 0xb9486167ab9087ab818dc4ce026edb5bf216863364c32e42df2af03c5ced1ad181e7d12f0e6dd5307a73b62247608611 --chain-id ${chainid}) 2>&1)
    returncode=$?
...
test_HMY_Validator_Edit_Website_lenght() {
    output=$((${HMYCLIPATH} --node=http://${apiendpoint} staking edit-validator --validator-addr ${VALIDATOR_ADDR} --name John --identity John --website john@harmony.one_gjuDthEfXKsguvVih7WEFGgQRbolcgAeg40lO6zz0pHsfbh2sdMarB9mmopL6WdQlCJ3CJmp2437Qw4Hcyp47L2gBhNTZ8D6DjQ0UkK42Q5JkB3GuDUiyMNtMEVNXiN5ddTWQtcfuJ5P --security-contact Alex --details "John the validator" --rate 0.1 --min-self-delegation 2 --max-total-delegation 30 --remove-bls-key 0xb9486167ab9087ab818dc4ce026edb5bf216863364c32e42df2af03c5ced1ad181e7d12f0e6dd5307a73b62247608611 --add-bls-key 0xb9486167ab9087ab818dc4ce026edb5bf216863364c32e42df2af03c5ced1ad181e7d12f0e6dd5307a73b62247608611 --chain-id ${chainid}) 2>&1)
    returncode=$?
...
test_HMY_Validator_Edit_SecurityContact_lenght() {
    output=$((${HMYCLIPATH} --node=http://${apiendpoint} staking edit-validator --validator-addr ${VALIDATOR_ADDR} --name John --identity John --website john@harmony.one --security-contact Alex_gjuDthEfXKsguvVih7WEFGgQRbolcgAeg40lO6zz0pHsfbh2sdMarB9mmopL6WdQlCJ3CJmp2437Qw4Hcyp47L2gBhNTZ8D6DjQ0UkK42Q5JkB3GuDUiyMNtMEVNXiN5ddTWQtcfuJ5P --details "John the validator" --rate 0.1 --min-self-delegation 2 --max-total-delegation 30 --remove-bls-key 0xb9486167ab9087ab818dc4ce026edb5bf216863364c32e42df2af03c5ced1ad181e7d12f0e6dd5307a73b62247608611 --add-bls-key 0xb9486167ab9087ab818dc4ce026edb5bf216863364c32e42df2af03c5ced1ad181e7d12f0e6dd5307a73b62247608611 --chain-id ${chainid}) 2>&1)
    returncode=$?
...
test_HMY_Validator_Edit_Detail_lenght() {
    output=$((${HMYCLIPATH} --node=http://${apiendpoint} staking edit-validator --validator-addr ${VALIDATOR_ADDR} --name John --identity John --website john@harmony.one --security-contact Alex --details "John the validator " --rate 0.1  --min-self-delegation 2 --max-total-delegation 30 --remove-bls-key 0xb9486167ab9087ab818dc4ce026edb5bf216863364c32e42df2af03c5ced1ad181e7d12f0e6dd5307a73b62247608611 --add-bls-key 0xb9486167ab9087ab818dc4ce026edb5bf216863364c32e42df2af03c5ced1ad181e7d12f0e6dd5307a73b62247608611 --chain-id ${chainid}) 2>&1)
    returncode=$?
...
test_HMY_Validator_Edit_min_self_delegation_greater_than_1() {
    output=$((${HMYCLIPATH} --node=http://${apiendpoint} staking edit-validator --validator-addr ${VALIDATOR_ADDR} --name John --identity John --website john@harmony.one --security-contact Alex --details "John the validator" --rate 0.1 --min-self-delegation 0 --max-total-delegation 30 --remove-bls-key 0xb9486167ab9087ab818dc4ce026edb5bf216863364c32e42df2af03c5ced1ad181e7d12f0e6dd5307a73b62247608611 --add-bls-key 0xb9486167ab9087ab818dc4ce026edb5bf216863364c32e42df2af03c5ced1ad181e7d12f0e6dd5307a73b62247608611 --chain-id ${chainid}) 2>&1)
    returncode=$?
...
test_HMY_Validator_Creation_max_total_delegation_greater_than_min_self_delgation() {
    output=$((${HMYCLIPATH} --node=http://${apiendpoint} staking create-validator --validator-addr ${VALIDATOR_ADDR} --name John --identity John --website john@harmony.one --security-contact Alex --details "John the validator" --rate 0.1 --max-rate 0.9 --max-change-rate 0.05 --min-self-delegation 20 --max-total-delegation 10 --bls-pubkeys 0xb9486167ab9087ab818dc4ce026edb5bf216863364c32e42df2af03c5ced1ad181e7d12f0e6dd5307a73b62247608611 --amount 3 --chain-id ${chainid}) 2>&1)
    returncode=$?
    ...
    assertContains 'Testing Validator Create max_total_delegation should be greater than min self delgation' "${output}" 'max_total_delegation can not be less than min_self_delegation'
}
test_HMY_Validator_Edit_max_total_delegation_greater_than_min_self_delgation() {
    output=$((${HMYCLIPATH} --node=http://${apiendpoint} staking edit-validator --validator-addr ${VALIDATOR_ADDR} --name John --identity John --website john@harmony.one --security-contact Alex --details "John the validator" --rate 0.1 --min-self-delegation 20 --max-total-delegation 20 --remove-bls-key 0xb9486167ab9087ab818dc4ce026edb5bf216863364c32e42df2af03c5ced1ad181e7d12f0e6dd5307a73b62247608611 --add-bls-key 0xb9486167ab9087ab818dc4ce026edb5bf216863364c32e42df2af03c5ced1ad181e7d12f0e6dd5307a73b62247608611 --chain-id ${chainid}) 2>&1)
    returncode=$?
