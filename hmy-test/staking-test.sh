...
test_HMY_Validator_Creation_Name_lenght() {
    ...
    assertEquals 'Testing Validator Create Name lenght test above 70' "Exceed Maximum Length name 70" "${output}"
  #assertContains 'Testing Validator creation name lenghts and should be below 70 chars' "${output}" 'Exceed Maximum'
}
...
test_HMY_Validator_Creation_Identity_lenght() {
  ...
  #assertContains 'Testing Validator creation Identity lenghts and should be below 3000 chars' "${output}" 'Exceed Maximum'
}
